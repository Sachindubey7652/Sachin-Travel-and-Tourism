...
public class Destinations extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text = new String[]{"Raddison Blu","The Charans","Five Senses","Buddha Hotel","Madhuban Hotel","Radha Krishna Hotel","The Haveli","Champaran Hotel","Hotel Ayodhya","The Taj Hotel"};
    ...
    Destinations(){
        ...
        for(int i=0;i<9;i++){
        image[i] = new ImageIcon(ClassLoader.getSystemResource("icons/dest"+(i+1)+".jpeg"));
